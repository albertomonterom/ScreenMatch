...
public class Principal {
    ...
    private EpisodioRepository repositorioEpisodio;
    private List<Serie> series;
    private Optional<Serie> serieBuscada;
    public Principal(SerieRepository repository, EpisodioRepository repositoryEpisodio) {
        this.repositorio = repository;
        this.repositorioEpisodio = repositoryEpisodio;
    }
    ...
    public void muestraElMenu() {
        ...
        while (opcion != 0) {
            var menu = """
                    ...
                    6 - Series por categoría
                    7 - Series por temporadas y evaluación
    ...
    private void buscarEpisodiosPorTitulo() {
        ...
        List<Episodio> episodiosEncontrados = repositorioEpisodio.episodiosPorNombre(nombreEpisodio);
        episodiosEncontrados.forEach(e -> System.out.printf("Serie: %s Temporada %d Episodio %d Evaluación %.2f \n", e.getSerie().getTitulo(), e.getTemporada(), e.getNumeroEpisodio(), e.getEvaluacion()));
    }
    private void buscarTop5Episodios() {
        buscarSeriesPorTitulo();
        if(serieBuscada.isPresent()){
            Serie serie = serieBuscada.get();
            List<Episodio> topEpisodios = repositorioEpisodio.top5Episodios(serie.getTitulo());
            topEpisodios.forEach(e -> {
                System.out.printf("Serie: %s - Temporada %d - Episodio %d - Evaluacion %.2f\n",
                        e.getSerie().getTitulo(), e.getTemporada(), e.getNumeroEpisodio(), e.getEvaluacion());
            });
        }
    }
